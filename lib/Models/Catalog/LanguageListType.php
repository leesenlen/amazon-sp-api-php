 ...
 * @author   Stefan Neuhaus / ClouSale
 */
class LanguageListType extends Categories implements ModelInterface, ArrayAccess
{
     ...
     * @var string
     */
    protected static $swaggerModelName = 'LanguageListType';
    ...
    {
        $this->container['language_tag'] = $languageTag;
